...
REM 你原本的工具路徑（不動）
REM ===================================================
set "WHISPER=C:\_install\Whisper_F\main.exe"
set "MODEL=C:\_install\Whisper_F\ggml-medium.bin"
set "FFMPEG=C:\_install\Whisper_F\ffmpeg.exe"

REM ===================================================
REM 讓你輸入要辨識的目錄（可拖曳資料夾進來）
REM 預設：f:\F\作者
REM ===================================================
set "DEFAULT_DIR=f:\F\作者"
